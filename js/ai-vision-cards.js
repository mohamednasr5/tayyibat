...
(function () {
  ...
  var TIMEOUT_MS = 60000;   // 60 ثانية للرؤية — منع قطع الإجابات الطويلة
  var LIVE_DELAY = 2000;
  var LIVE_INTERVAL = 4000;
  var IMG_QUALITY = 0.92;
          ...
          var resp2 = await Promise.race([
            fetch('https://text.pollinations.ai/openai', {
              ...
              body: JSON.stringify({
                ...
                max_tokens: 4096, temperature: 0.3, private: true
              })
            }), tp2
          ]);
...
async function _toWorkerWithFallback(imgDataUrl, prompt) {
  ...
  var PROMPTS = {
    ...
    /* ─── دواء (نسخة محسّنة — إجابة كاملة غير مقطوعة) ─── */
    medicine:
      'أنت صيدلاني خبير متخصص. افحص هذه الصورة — قد تكون دواءً أو عبوة دواء أو ورقة ارشادات.\n' +
      'استخرج كل المعلومات الدوائية المتاحة بشكل مفصل وكامل دون اختصار:\n\n' +
      '💊 اسم الدواء التجاري:\n' +
      '🔬 المادة الفعّالة (الاسم العلمي):\n' +
      '🏭 الشركة المصنعة والبلد:\n' +
      '📋 التركيز والجرعة المتاحة:\n' +
      '🎯 دواعي الاستعمال الكاملة والتفصيلية:\n(اذكر جميع الحالات التي يُستخدم فيها هذا الدواء بالتفصيل)\n' +
      '⏱️ طريقة الاستخدام والجرعة المعتادة لكل فئة (بالغون/أطفال/مسنون):\n' +
      '🍽️ العلاقة بالأكل (قبل/بعد/مع الطعام وسبب ذلك):\n' +
      '⚠️ موانع الاستخدام الكاملة والتحذيرات المهمة:\n' +
      '🔄 التفاعلات الدوائية الهامة مع أدوية أخرى:\n' +
      '🤒 الآثار الجانبية الشائعة والنادرة:\n' +
      '🤰 الاستخدام خلال الحمل والرضاعة:\n' +
      '❄️ شروط التخزين الصحيحة:\n' +
      '💡 نصيحة مهمة ومفيدة للمريض:\n' +
      '⚠️ تنبيه: هذا للمعلومات فقط — استشر طبيبك أو صيدلانيك دائماً.\n' +
      'اكتب بالعربية بوضوح وشمولية كاملة دون قطع أو اختصار أي معلومة.',
